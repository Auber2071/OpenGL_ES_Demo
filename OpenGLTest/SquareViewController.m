...
- (void)setupData {
    _vertex[0] = GLKVector3Make(-0.5, -0.5,  0.5); // 前左下
    _vertex[1] = GLKVector3Make( 0.5, -0.5,  0.5); // 前右下
    _vertex[2] = GLKVector3Make( 0.5,  0.5,  0.5); // 前右上
    _vertex[3] = GLKVector3Make(-0.5,  0.5,  0.5); // 前左上
    _vertex[4] = GLKVector3Make(-0.5, -0.5, -0.5); // 后左下
    _vertex[5] = GLKVector3Make( 0.5, -0.5, -0.5); // 后右下
    _vertex[6] = GLKVector3Make( 0.5,  0.5, -0.5); // 后右上
    _vertex[7] = GLKVector3Make(-0.5,  0.5, -0.5); // 后左上
    ...
    _colors[5] = GLKVector4Make(1.0, 1.0, 0.0, 1.0);
    _colors[6] = GLKVector4Make(1.0, 0.0, 1.0, 1.0);
    _colors[7] = GLKVector4Make(1.0, 1.0, 1.0, 1.0);
...
- (void)setupEffect {
    ...
    //加载纹理图片
    NSString *path = [[NSBundle mainBundle] pathForResource:@"muxiang" ofType:@"jpeg"];
